...
# Override with THIN_SLICE_TOKEN_THRESHOLD env var.
...
def handle_app_mention(body, say, logger):
    ...
    try:
        ...
        say(
            text=f"Sorry, something went wrong while processing your request.\nError: {exc}",
            thread_ts=thread_ts,
        )
...
def handle_budget_reply(message, say, logger):
    ...
    try:
        ...
        # "no go" — re-slice to a smaller scope and re-evaluate
